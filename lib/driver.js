...
let ensureRightCaps = function(opts) {
  ...
  opts.bundleId = process.env.XTC_APP_ID; // todo: considder removing from TestCloudSpoofer
}
...
class IosDriver extends BaseDriver {
  ...
  async createSession (caps) {
    ensureRightCaps(caps);


    logger.error(`caps: ${caps}`);
